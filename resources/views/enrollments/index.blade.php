            ...
            <div class="my-auto">
                ...
                <nav>
                    <ol class="flex items-center whitespace-nowrap min-w-0">
                        <li class="text-[12px]"> <a class="flex items-center  text-primary hover:text-primary" href="{{ route('enrollments.index') }}">
                                Enrollment</a> </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="box custom-box">
            <div class="box-header flex justify-between">
                ...
                <div class="prism-toggle">
                    <a href="{{ route('enrollments.create') }}" class="ti-btn !py-1 !px-2 ti-btn-primary !font-medium !text-[0.75rem]">Add Enrollment
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td>
                                            <div class="hstack gap-2 flex-wrap">
                                                <a href="{{ route('enrollments.edit', $user->id) }}"
                                                    class="text-info text-[.875rem] leading-none border-0 bg-transparent"><i
                                                        class="ri-edit-line"></i></a>
                                                <form action="{{ route('enrollments.destroy', $user->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this enrollment?');">
                                                    @csrf
                                                    @method('DELETE')
